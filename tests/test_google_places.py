...
class TestSearchFiltering:
    ...
    def test_filters_type_blocklist(self, mock_increment, mock_get):
        ...
        mock_response.json.return_value = {
            'status': 'OK',
            'results': [
                {'place_id': '1', 'name': 'Big Supermarket', 'vicinity': '123 Main St', 'types': ['supermarket', 'store']},
    ...
    def test_deduplicates_across_categories(self, mock_increment, mock_get):
        ...
        with patch.dict('os.environ', {'GOOGLE_PLACES_API_KEY': 'test-key', 'OMNI_SEARCH_CATEGORIES': 'plumber,electrician'}):
