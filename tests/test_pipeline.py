...
class TestPipelineScoring:
    ...
    def test_calculates_full_score_for_good_site(self, mock_lead_class, mock_analyze, mock_details, mock_db):
    ...
    @patch("app.services.pipeline.analyze_url")
    @patch("app.services.pipeline.Lead")
    def test_calculates_partial_score_for_poor_site(self, mock_lead_class, mock_analyze, mock_details, mock_db):
...
class TestPipelineStatusTransition:
    ...
    @patch("app.services.pipeline.analyze_url")
    @patch("app.services.pipeline.Lead")
    def test_transitions_scraped_to_analyzed(self, mock_lead_class, mock_analyze, mock_details, mock_db):
    ...
    @patch("app.services.pipeline.analyze_url")
    @patch("app.services.pipeline.Lead")
    def test_does_not_change_non_scraped_status(self, mock_lead_class, mock_analyze, mock_details, mock_db):
    ...
    @patch("app.services.pipeline.analyze_url")
    @patch("app.services.pipeline.Lead")
    def test_sets_analyzed_at_timestamp(self, mock_lead_class, mock_analyze, mock_details, mock_db):
...
class TestPipelineErrorHandling:
    ...
    @patch("app.services.pipeline.analyze_url")
    @patch("app.services.pipeline.Lead")
    def test_handles_commit_failure(self, mock_lead_class, mock_analyze, mock_details, mock_db):
